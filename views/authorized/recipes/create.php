...
<?php include(ROOT_PATH . '/views/includes/authorized/header.php'); ?>
    <div class="dashboard-content">
        ...
        <form action="create.php" method="POST" class="form contact-form"  enctype="multipart/form-data">
            <input type="hidden" name="user_id" class="form-input" value="777" />
            ...
            <button type="submit" name="add-recipe" class="btn btn-block">
                add
            </button>
        </form>  
    </div>
